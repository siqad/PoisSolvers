#ifndef POISSONSOLVER_REF_MATRIX_H
#define POISSONSOLVER_REF_MATRIX_H

//  C++ Matrix Objects adapted from Stroustrup's Matrix.h and MatrixIO.h
...
// protected:
        ...
        // for use by Row: ---- changed to public to construct from array
        //                 ---- this assumes array size >= n1 dangerous!!
    public:
...
//-----------------------------------------------------------------------------
    ...
    public:
        ...
        Matrix() : Matrix_base<T>(1), d1(1), d2(1) { }
...
#endif //POISSONSOLVER_REF_MATRIX_H
