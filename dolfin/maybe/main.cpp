...
int main()
{
  ...
  BoxMesh mesh(Point(0, 0, 0),Point(0.1, 0.2, 0.3), 10, 20, 30);
  //plot(mesh);
  //interactive();
  //std::getchar();
  Poisson::FunctionSpace V(mesh);
  //V.print_dofmap();
  cout << "Dimension of FunctionSpace is: " << V.dim() << endl;
  /* BC */
  Constant v0(0, 0);
  DirichletBoundary dBC(0.3,1);
  DirichletBC dirbc(V,v0,dBC, "pointwise");
