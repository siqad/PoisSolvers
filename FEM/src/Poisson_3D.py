...
#dielectric seam
mw.addSurface([0.999*boundary_x_min,0.999*boundary_y_min,boundary_dielectric],\
              [0.999*boundary_x_max,0.999*boundary_y_min,boundary_dielectric],\
              [0.999*boundary_x_max,0.999*boundary_y_max,boundary_dielectric],\
              [0.999*boundary_x_min,0.999*boundary_y_max,boundary_dielectric],0.5, "seam")
