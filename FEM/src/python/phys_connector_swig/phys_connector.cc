...
void PhysicsConnector::setExport(std::string key, std::vector< std::pair< std::string, std::string > > &data_in)
{
    if (key == "db_loc"){
...
void PhysicsConnector::setExport(std::string key, std::vector< std::vector< std::string > > &data_in)
{
    if (key == "potential"){
...
void PhysicsConnector::setElecPotentialData(std::vector<std::vector<std::string>> &data_in)
{
  setExportElecPotential(true);
  pot_data = data_in;
}

void PhysicsConnector::setElectrodeData(std::vector<std::vector<std::string>> &data_in)
{
...
void PhysicsConnector::setDBChargeData(std::vector< std::pair< std::string, std::string > > &data_in)
{
...
{
  double x1, x2, y1, y2;
  double potential, pixel_per_angstrom, phase;
  ...
  phase = subtree.get<double>("phase");
