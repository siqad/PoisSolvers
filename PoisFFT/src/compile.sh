...
g++ -std=c++11 -o /home/nathan/git/PoisSolvers/PoisFFT/bin/gcc/problem.o -c -O3 -g problem.cc
g++ -std=c++11 -o /home/nathan/git/PoisSolvers/PoisFFT/bin/gcc/phys_engine.o -c -O3 -g phys_engine.cc
