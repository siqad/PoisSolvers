...
g++ -o /home/nathan/git/PoisSolvers/PoisFFT/bin/gcc/electrodes.o -c -O3 -g electrodes.cpp
g++ -o /home/nathan/git/PoisSolvers/PoisFFT/bin/gcc/cc_testpoisson.o -c -O3 -g testpoisson.cpp
